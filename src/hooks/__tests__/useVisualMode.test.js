...
//Setting modes (initial(1st), second...) 
//helps users go from one component view to another, such as Empty to Create
const FIRST = "FIRST";
const SECOND = "SECOND";
const THIRD = "THIRD";
...
test("useVisualMode should return the previous mode", () => {
  const { result } = renderHook(() => useVisualMode(FIRST));
